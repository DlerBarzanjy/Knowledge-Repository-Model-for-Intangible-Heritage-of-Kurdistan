...
<IMG alt="" id=LMImageImg7 src="./images/gallery0.jpg" class="cLMImageImg7"></DIV>
...
<div align="center">
  <?php
	...
	{
		$ret = 	'<form method="post" action="clear_table1.php">';
	...
	*/
		...
		echo "<table border=1>\n";
		echo "<tr><th>FileName</th><td><a href=\"download2.php?fid=$rad[0]\"><strong>$rad[1]</strong></a></td></tr>";
