...
<link href="blog_adim.css" rel="stylesheet" type="text/css">
</head>
...
<script type="text/javascript" src="./menusystemmodel029.js"></script><noscript><br></noscript>
...
[<a href='./home_admin.html' title=""></a>]<br>
[<a href='./gallery_admin.php' title=""></a>]<br>
[<a href='./video_admin.php' title=""></a>]<br>
[<a href='./blog-admin.html' title=""></a>]<br>
[<a href='./contact_admin.php' title=""></a>]<br>
[<a href='./manage_user.php' title=""></a>]<br>
...
<IMG alt="" id=LMImageLine3 src="./images/blog_adim_Line3.jpg" class="cLMImageLine3"></DIV>
<DIV id=Line4 CLASS="cLine4">
<a name=ANCHOR_Line4></a>
<IMG alt="" id=LMImageLine4 src="./images/blog_adim_Line4.jpg" class="cLMImageLine4"></DIV>
<DIV id=Box4 class="cBox4">
<a name=ANCHOR_Box4></a>
<IMG alt="" id=LMImageBox4 src="./images/blog_adim_Box4.jpg" class="cLMImageBox4"></DIV>
...
<IMG alt="" id=LMImageBox5 src="./images/blog_adim_Box5.jpg" class="cLMImageBox5"></DIV>
...
<IMG alt="" id=LMImageBox1 src="./images/blog_adim_Box1.jpg" class="cLMImageBox1"></DIV>
...
<IMG alt="" id=LMImageBox3 src="./images/blog_adim_Box3.jpg" class="cLMImageBox3"></DIV>
...
<h2 align="left">Add Your Blog Here !</h2>
<form enctype="multipart/form-data" [ccc] action="upload_to_sql3.php" method="POST">
  <div align="left">
...
<IMG alt="" id=LMImageBox6 src="./images/blog_adim_Box6.jpg" class="cLMImageBox6"></DIV>
...
menusystemmodel029Show(46, 84, "Menu8");
...
<div align="center">
  <?php
	...
	include "sql_data3.php";  // File that contains the SQL connection information.

	
	function createDeleteButton($fid)
	{
		$ret = 	'<form method="post" action="clear_table3.php">';
	...
	echo '<form method="post" action="clear_table3.php">'."\n";
