...
<link href="gallery_user.css" rel="stylesheet" type="text/css">
</head>
...
<div align="left"><font face="Verdana" color="#ffffff" size="2"><span style=" font-size:10pt"><b>Blog</b></span></font></div>
</DIV>
</DIV>
<DIV id=Box2 class="cBox2">
<div align="justify"><a name=ANCHOR_Box2></a>
 <?php
?>
</div>
<h2 align="justify">Add Your Blog Here !</h2>
<form enctype="multipart/form-data" [ccc] action="upload_to_sql1.php" method="POST">
  ...
  <?php
	...
	echo "<h2>List of uploaded Blogs</h2>\n";
	login_mysql();
	select_db(FALSE);
	$sql = "SELECT fid, fileName, fileSize, description, userName, userStreetAddress FROM blog";
	...
	*/
		...
		echo "<table border=1>\n";
		echo "<tr><th>FileID</th><td>$rad[0]</a></td></tr>";
		//echo "<tr><th>UserName</th><td>$rad[2]</td></tr>";
		echo "<tr><th>Blog</th><td>$rad[3]</td></tr>";
...
<IMG alt="" id=LMImageImg7 src="./images/bl.jpg" class="cLMImageImg7"></DIV>
...
<IMG alt="" id=LMImageLine13 src="./images/gallery_user_Line13.jpg" class="cLMImageLine13"></DIV>
...
<IMG alt="" id=LMImageLine8 src="./images/gallery_user_Line8.jpg" class="cLMImageLine8"></DIV>
...
<IMG alt="" id=LMImageLine3 src="./images/gallery_user_Line3.jpg" class="cLMImageLine3"></DIV>
<DIV id=Line9 CLASS="cLine9">
<a name=ANCHOR_Line9></a>
<IMG alt="" id=LMImageLine9 src="./images/gallery_user_Line9.jpg" class="cLMImageLine9"></DIV>
<DIV id=Line4 CLASS="cLine4">
<a name=ANCHOR_Line4></a>
<IMG alt="" id=LMImageLine4 src="./images/gallery_user_Line4.jpg" class="cLMImageLine4"></DIV>
<DIV id=Box4 class="cBox4">
<a name=ANCHOR_Box4></a>
<IMG alt="" id=LMImageBox4 src="./images/gallery_user_Box4.jpg" class="cLMImageBox4"></DIV>
...
<IMG alt="" id=LMImageBox5 src="./images/gallery_user_Box5.jpg" class="cLMImageBox5"></DIV>
...
<IMG alt="" id=LMImageBox1 src="./images/gallery_user_Box1.jpg" class="cLMImageBox1"></DIV>
...
<IMG alt="" id=LMImageBox3 src="./images/gallery_user_Box3.jpg" class="cLMImageBox3"></DIV>
<DIV id=Gmenu class="cGmenu">
<a name=ANCHOR_Gmenu></a>
</DIV>
<DIV id=Box6 class="cBox6">
<a name=ANCHOR_Box6></a>
<IMG alt="" id=LMImageBox6 src="./images/gallery_user_Box6.jpg" class="cLMImageBox6"></DIV>
...
branchlist = new Array();
LMObjects[objindex++] = LMText("Text46",1,0,null,0,null,branchlist,null,null,15,15,15,15);
