...
<div>
  <?php
	...
	echo "<h4>Here in Gallery, the you can view the uploaded files, such as images, videos and songs.</h4>\n";
	login_mysql();
	select_db(FALSE);
...
<IMG alt="" id=LMImageImg2 src="./images/gallery0.jpg" class="cLMImageImg2"></DIV>
