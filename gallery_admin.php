...
<link href="gallery_admin.css" rel="stylesheet" type="text/css">
</head>
...
[<a href='./blog_adim.php' title=""></a>]<br>
...
<IMG alt="" id=LMImageLine3 src="./images/gallery_admin_Line3.jpg" class="cLMImageLine3"></DIV>
<DIV id=Line4 CLASS="cLine4">
<a name=ANCHOR_Line4></a>
<IMG alt="" id=LMImageLine4 src="./images/gallery_admin_Line4.jpg" class="cLMImageLine4"></DIV>
<DIV id=Box4 class="cBox4">
<a name=ANCHOR_Box4></a>
<IMG alt="" id=LMImageBox4 src="./images/gallery_admin_Box4.jpg" class="cLMImageBox4"></DIV>
...
<IMG alt="" id=LMImageBox5 src="./images/gallery_admin_Box5.jpg" class="cLMImageBox5"></DIV>
...
<IMG alt="" id=LMImageBox1 src="./images/gallery_admin_Box1.jpg" class="cLMImageBox1"></DIV>
...
<IMG alt="" id=LMImageBox3 src="./images/gallery_admin_Box3.jpg" class="cLMImageBox3"></DIV>
...
<form enctype="multipart/form-data" [ccc] action="upload_to_sql2.php" method="POST">
  <div align="left">
...
<IMG alt="" id=LMImageBox6 src="./images/gallery_admin_Box6.jpg" class="cLMImageBox6"></DIV>
...
*/
	...
	*/
		...
		echo "<table border=1>\n";
		echo "<tr><th>FileName</th><td><a href=\"download.php?fid=$rad[0]\"><strong>$rad[1]</strong></a></td></tr>";
